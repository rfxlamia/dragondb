  ...
  return (
    <div className="connection-form">
      ...
      {connectionStringMode ? (
        ...
        <>
          <div className="connection-form__group">
            <p className="connection-form__group-label">{ConnectionCopy.groupAddress}</p>
            <div className="connection-form__row">
              ...
              <label className="connection-form__field">
                ...
                <input
                  ...
                  onChange={(e) =>
                    onChange(
                      patchProfile(value, { port: Number.parseInt(e.target.value, 10) || 0 }),
                    )
                  }
                />
              </label>
          ...
          <div className="connection-form__group">
            <p className="connection-form__group-label">{ConnectionCopy.groupAuth}</p>
            <label className="connection-form__field">
              ...
              <>
                ...
                <label className="connection-form__field">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      onChange(patchSecrets(value, { sshPassphrase: e.target.value }))
                    }
                  />
                </label>
              </>
